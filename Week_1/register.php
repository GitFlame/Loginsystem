...
$sql = "INSERT INTO `details` (`id`,`username`,`lastname`, `email_id`, `password`) VALUES ('id','$username','$lastname', '$email','$encpassword')";
...
//php mailer code
    ...
    try {
        ...
        $mail->Body = "Hello $username $lastname.<br> Thank you for registering! we will assure you to give  the best experience !";
